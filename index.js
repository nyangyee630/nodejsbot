...
client.on('message', (message) => {
  ...
  if(message.content == '!si') {
    ...
    embed.setColor('#186de6')
    embed.setAuthor('server info of 냥냥봇 BOT', img)
    embed.setFooter(`냥냥봇 BOT ❤️`)
    embed.addBlankField()
  ...
  if(message.content == 'embed') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setAuthor('냥이', img, 'http://www.naver.com')
      .setThumbnail(img)
      .addBlankField()
    ...
    let commandStr = '';
    let embed = new Discord.RichEmbed()
      .setAuthor('Help of 냥냥봇 BOT', helpImg)
      .setColor('#186de6')
      .setFooter(`냥냥봇 BOT ❤️`)
      .setTimestamp()
